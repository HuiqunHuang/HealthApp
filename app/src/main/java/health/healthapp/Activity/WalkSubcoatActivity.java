...
public class WalkSubcoatActivity extends AppCompatActivity {
    ...
    private void walkchart(){
        ...
        walkchart = ChartFactory.getLineChartView(this, walk_dataset, walk_renderer);///this改为context
    ...
    public static void setText(){
        ...
        walk_subcoat_step.setText(step+"步");
        walk_subcoat_calorie.setText((int)calorie+"卡");
        walk_subcoat_dis.setText(distance+"m");
        walk_subcoat_steplength.setText(step_length+"cm");
        walk_subcoat_speed.setText(speed+"km/h");
        walk_subcoat_striderate.setText(stride_rate+"步/min");
